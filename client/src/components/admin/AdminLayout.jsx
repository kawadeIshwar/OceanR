...
import { LayoutDashboard, Package, FolderTree, LogOut, Menu, X, Bell, Settings } from 'lucide-react';
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/admin/dashboard" className="flex items-center gap-3">
                <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-white to-gray-300 rounded-xl shadow-lg overflow-hidden">
                  <img 
                    src="/oceanr logo.png" 
                    alt="OceanR Logo" 
